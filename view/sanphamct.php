                  ...
                  <div class="product-single-thumb">
                      ...
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <a class="lightbox-image" data-fancybox="gallery" href="assets/img/shop/product-single/1.jpg">
                            <img src="assets/img/shop/product-single/1.jpg" width="570" height="675" alt="Image-HasTech">
                          </a>
                        </div>
                        <div class="swiper-slide">
                    ...
                    <div class="product-single-swiper-wrap position-relative">
                      <div class="swiper single-product-nav single-product-nav-slider">
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <img src="assets/img/shop/product-single/nav1.jpg" width="127" height="127" alt="Image-HasTech">
                          </div>
                          <div class="swiper-slide">
